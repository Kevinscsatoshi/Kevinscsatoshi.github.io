...
window.I18N = {
  zh: {
    site: {
      ...
      description: "顾思聪（Kevin Sicong Gu），宁德时代（CATL）储能电气工程师。个人网站：经历、摄影旅行、Vibe 项目与 Blog。",
    },
  ...
  en: {
    site: {
      ...
      description: "Kevin Sicong Gu (顾思聪), energy storage electrical engineer at CATL. Experience, photography and travel, vibe projects and a blog.",
    },
  ...
  ja: {
    site: {
      ...
      description: "顧 思聡（Kevin Sicong Gu）の個人サイトです。CATL（寧徳時代）で蓄電システムの電気エンジニアとして勤務。経歴、写真と旅の記録、Vibe プロジェクト、ブログを掲載しています。",
    },
